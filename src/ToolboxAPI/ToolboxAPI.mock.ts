...
class ToolboxAPIMock implements API {
    ...
    constructor() {
        ...
        this.fileSystem = new FileSystemAPIMock();
        this.settings = new SettingsAPIMock();
        this.terminal = new TerminalAPIMock();
        this.events = new EventsAPIMock();
        this.getToolContext = stub();
        this.getToolContext.resolves({
            toolId: "mockToolId",
